...
const NewPostButton = ({}) => {
  return (
    <button className="new-post-button">
      <PostIcon primaryColor="currentColor" secondaryColor="#607d8b"></PostIcon>
      {/* <img
        className="post-icon" 
...
const PostIcon = ({size=30, primaryColor="currentColor", secondaryColor="black"}) => {
  // TODO: Use a mask instead in order to allow transparent paths which are not the 
