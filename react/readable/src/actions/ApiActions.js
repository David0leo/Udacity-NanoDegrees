...
export function downVotePostById(id) {
	return function(dispatch) {
		return API.downVotePostById(id)
			.then(post => {
...
export function getCommentByCommentId(id) {
	return function(dispatch) {
		return API.getCommentByCommentId(id)
			.then(comment => {
...
export function upVoteCommentByCommentId(id) {
	return function(dispatch) {
		return API.upVoteCommentByCommentId(id)
			.then(comment => {
...
export function downVoteCommentByCommentId(id) {
	return function(dispatch) {
		return API.downVoteCommentByCommentId(id)
			.then(comment => {
...
export function deleteCommentByCommentId(id) {
	return function(dispatch) {
		return API.deleteCommentByCommentId(id)
			.then(comment => {
...
export function loadCommentsAndUpdateCommentCountByPostId(id, comments) {
	return {
		type: LOAD_COMMENTS_AND_UPDATE_COMMENT_COUNT_BY_POST_ID_SUCCESS,
		id,
		comments
	};
}
